...
Tags: css, javascript, jQuery, contact form 7, international, i18n, international code, country code, telephone
Stable tag: trunk
Requires at least: 1.4.3
Tested up to: 4.7
...
2. In "Search Plugins" field enter "Contact Form 7 - International Telephone Input" and search

 ...
 * Description: This plugins uses a jQuery plugin called International Telephone Input to add the capability to choose in a falg dropdow your country code
 * Version: 1.5.1
 * Author: Damià Rita

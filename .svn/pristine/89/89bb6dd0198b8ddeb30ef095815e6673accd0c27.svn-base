...
function wpcf7_intl_tel_add_static_files(){
    wp_enqueue_script( 'wpcf7-intl-tel-lib-js', 'https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/7.0.1/js/intlTelInput.min.js' ,  array( 'jquery' ), '7.0.1', true);
    ...
    wp_enqueue_script( 'wpcf7-intl-tel-js', plugins_url( 'script.min.js', __FILE__ ), array('jquery'), '1.1.0', true);
